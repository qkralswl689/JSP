...
<!-- 회원가입 CSS -->
<link rel="stylesheet" href="/member_project/css/member_join.css">
...
<script src="/member_project/js/member_join.js" charset="UTF-8"></script>
	...
	<div id="join_wrap">
	    ...
	    <div id="joinFormPnl">
		    ...
		    <form id="joinForm" 
		    	  name="joinForm" 
		          method="post"
		          action="/member_project/member/joinProc.do">
