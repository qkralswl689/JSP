...
window.onload = function() {
	...
	pw_search_btn.onclick = function() {
		location.href = "${pageContext.request.contextPath}/template.do?content_page=/member/pw_lost_search.jsp";
	} //
...
<body>
	...
	<div id="wrap" class="mx-auto">
		...
		<div id="id_search_box" class="container">
		
			<div>
				<!-- 크롬 자동 완성 기능 삭제 : autocomplete="off"-->
				<form class="form-inline"
				 	  autocomplete="off" 
					  action="${pageContext.request.contextPath}/member/idSearchProc.do" 
					  method="POST">
					...
					<table id="id_search_tbl">
						 ...
						 <tr>
						 	<td colspan="2" style="text-align:center; height:70px">
			                	<input type="submit" class="btn btn-primary" value="아이디 검색" />&nbsp;
			                	<input type="reset" class="btn btn-primary" value="취소" />&nbsp;
			                	<input type="button" class="btn btn-outline-primary" id="pw_search_btn" value="비밀번호 검색">
		              		</td>
	              		 </tr>
